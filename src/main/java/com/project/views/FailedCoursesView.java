...
import com.project.views.components.FailedCoursesPanel;
...
@Route("vaadin_project/failed_courses")
@Secured("ROLE_USER")
public class FailedCoursesView extends VerticalLayout implements BeforeEnterObserver {

    private UserControllerInterface controllerInterface;
    private AdminControllerInterface adminControllerInterface;
    private HeaderPanel headerPanel;
    private NavPanel navPanel;
    private FailedCoursesPanel failedCoursesPanel;
    private HorizontalLayout horizontalLayout;
    private FlexLayout footerLayout;

    public FailedCoursesView(UserControllerInterface controllerInterface, AdminControllerInterface adminControllerInterface) {
    ...
    public void beforeEnter(BeforeEnterEvent beforeEnterEvent) {
        ...
        failedCoursesPanel = new FailedCoursesPanel(controllerInterface, beforeEnterEvent);
        horizontalLayout.removeAll();
        horizontalLayout.add(navPanel, failedCoursesPanel);
        this.removeAll();
