...
@Route("vaadin_project/finished_courses")
@Secured("ROLE_USER")
public class FinishedCoursesView  extends VerticalLayout implements BeforeEnterObserver {

    private UserControllerInterface controllerInterface;
    private AdminControllerInterface adminControllerInterface;
    private HeaderPanel headerPanel;
    private NavPanel navPanel;
    private FinishedCoursesPanel finishedCoursesPanel;
    private HorizontalLayout horizontalLayout;
    private FlexLayout footerLayout;

    public FinishedCoursesView(UserControllerInterface controllerInterface, AdminControllerInterface adminControllerInterface) {
    ...
    public void beforeEnter(BeforeEnterEvent beforeEnterEvent) {
        ...
        finishedCoursesPanel = new FinishedCoursesPanel(controllerInterface, beforeEnterEvent);
        horizontalLayout.removeAll();
        horizontalLayout.add(navPanel, finishedCoursesPanel);
        this.removeAll();
